 ...
 * 
 * La letras serán las correspondientes al alfabeto inglés 
 * (26 caracteres, excluimos la ñ y Ñ).
 * 
 * En este método de cifrado cada letra del texto se sustituye por otra letra 
 * que se encuentra N posiciones adelante en el alfabeto. 
 * 
...
public class Ejercicio_012 {
	...
	public static void main(String[] args) throws IOException {
        ...
        do {
            System.out.println("Introduce un texto (26 caracteres, excluimos la ñ y Ñ): ");
            texto = sc.nextLine();
        } while (texto.isEmpty());
